...
func TestSignMessageShouldWorkOk(t *testing.T) {
	// Giving
	dev := &mocks.Devicer{}
	orgMsg := "great"
	signMessageResp := messages.ResponseSkycoinSignMessage{SignedMessage: proto.String(orgMsg)}
	data, err := proto.Marshal(&signMessageResp)
	require.NoError(t, err)
	msg := wire.Message{
		Kind: uint16(messages.MessageType_MessageType_ResponseSkycoinSignMessage),
		Data: data,
	}
...
func TestSignMessageShouldHandleDeviceError(t *testing.T) {
	// Giving
	dev := &mocks.Devicer{}
...
func TestSignMessageShouldHandleErrorDecodingResponse(t *testing.T) {
	// Giving
	dev := &mocks.Devicer{}
	orgResp := "jhfjdhfjd"
	signMessageResp := messages.Failure{Message: proto.String(orgResp)}
	data, err := proto.Marshal(&signMessageResp)
	require.NoError(t, err)
	msg := wire.Message{
		Kind: uint16(messages.MessageType_MessageType_Failure),
...
func TestCancelShouldWorkOk(t *testing.T) {
	// Giving
	dev := &mocks.Devicer{}
	orgMsg := "great"
	cancelResp := messages.Failure{Message: proto.String(orgMsg)}
	data, err := proto.Marshal(&cancelResp)
	require.NoError(t, err)
	msg := wire.Message{
		Kind: uint16(messages.MessageType_MessageType_Failure),
		Data: data,
...
func TestCancelShouldHandleDeviceError(t *testing.T) {
	// Giving
	dev := &mocks.Devicer{}
...
func TestCancelShouldHandleErrorDecodingResponse(t *testing.T) {
	// Giving
	dev := &mocks.Devicer{}
	orgResp := "jhfjdhfjd"
	cancelResp := messages.Success{Message: proto.String(orgResp)}
	data, err := proto.Marshal(&cancelResp)
	require.NoError(t, err)
	msg := wire.Message{
		Kind: uint16(messages.MessageType_MessageType_Success),
