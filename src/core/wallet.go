...
type Wallet interface {
	...
	Transfer(to Address, amount uint64, options interface{}) error
	SendFromAddress(from []Address, to []TransactionOutput, change Address, options interface{}) error
	Spend(unspent, new []TransactionOutput, change Address, options interface{}) error
