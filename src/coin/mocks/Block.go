...
func (_m *Block) GetSize() (uint64, error) {
	ret := _m.Called()
...
// GetTotalAmount provides a mock function with given fields:
func (_m *Block) GetTotalAmount() (uint64, error) {
	ret := _m.Called()
...
func (_m *Block) GetTransactions() ([]core.Transaction, error) {
	ret := _m.Called()
