...
func (_m *Wallet) GenAddresses(addrType core.AddressType, startIndex uint32, count uint32, pwd core.PasswordReader) core.Iterator {
	ret := _m.Called(addrType, startIndex, count, pwd)

	var r0 core.Iterator
	if rf, ok := ret.Get(0).(func(core.AddressType, uint32, uint32, core.PasswordReader) core.Iterator); ok {
...
func (_m *Wallet) GetLoadedAddresses() (core.Iterator, error) {
	ret := _m.Called()
