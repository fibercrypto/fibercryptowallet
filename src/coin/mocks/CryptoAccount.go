...
func (_m *CryptoAccount) ListPendingTransactions() (core.Iterator, error) {
	ret := _m.Called()
...
func (_m *CryptoAccount) ListTransactions() core.Iterator {
	ret := _m.Called()
...
func (_m *CryptoAccount) ScanUnspentOutputs() core.Iterator {
	ret := _m.Called()
