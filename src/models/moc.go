...
//export callbackBlockchainStatusModel0d0160_Constructor
func callbackBlockchainStatusModel0d0160_Constructor(ptr unsafe.Pointer) {
...
//export callbackBlockchainStatusModel0d0160_Update
func callbackBlockchainStatusModel0d0160_Update(ptr unsafe.Pointer) {
...
func (ptr *BlockchainStatusModel) ConnectUpdate(f func()) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "update") {
			C.BlockchainStatusModel0d0160_ConnectUpdate(ptr.Pointer())
		}
...
func (ptr *BlockchainStatusModel) DisconnectUpdate() {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160_DisconnectUpdate(ptr.Pointer())
...
func (ptr *BlockchainStatusModel) Update() {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160_Update(ptr.Pointer())
	}
}

//export callbackBlockchainStatusModel0d0160_NumberOfBlocks
func callbackBlockchainStatusModel0d0160_NumberOfBlocks(ptr unsafe.Pointer) C.struct_Moc_PackedString {
...
func (ptr *BlockchainStatusModel) NumberOfBlocks() string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.BlockchainStatusModel0d0160_NumberOfBlocks(ptr.Pointer()))
	}
	return ""
}
...
func (ptr *BlockchainStatusModel) NumberOfBlocksDefault() string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.BlockchainStatusModel0d0160_NumberOfBlocksDefault(ptr.Pointer()))
	}
	return ""
}

//export callbackBlockchainStatusModel0d0160_SetNumberOfBlocks
func callbackBlockchainStatusModel0d0160_SetNumberOfBlocks(ptr unsafe.Pointer, numberOfBlocks C.struct_Moc_PackedString) {
...
func (ptr *BlockchainStatusModel) SetNumberOfBlocks(numberOfBlocks string) {
	if ptr.Pointer() != nil {
		...
		C.BlockchainStatusModel0d0160_SetNumberOfBlocks(ptr.Pointer(), C.struct_Moc_PackedString{data: numberOfBlocksC, len: C.longlong(len(numberOfBlocks))})
	}
}
...
func (ptr *BlockchainStatusModel) SetNumberOfBlocksDefault(numberOfBlocks string) {
	if ptr.Pointer() != nil {
		...
		C.BlockchainStatusModel0d0160_SetNumberOfBlocksDefault(ptr.Pointer(), C.struct_Moc_PackedString{data: numberOfBlocksC, len: C.longlong(len(numberOfBlocks))})
	}
}

//export callbackBlockchainStatusModel0d0160_NumberOfBlocksChanged
func callbackBlockchainStatusModel0d0160_NumberOfBlocksChanged(ptr unsafe.Pointer, numberOfBlocks C.struct_Moc_PackedString) {
...
func (ptr *BlockchainStatusModel) ConnectNumberOfBlocksChanged(f func(numberOfBlocks string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "numberOfBlocksChanged") {
			C.BlockchainStatusModel0d0160_ConnectNumberOfBlocksChanged(ptr.Pointer())
		}
...
func (ptr *BlockchainStatusModel) DisconnectNumberOfBlocksChanged() {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160_DisconnectNumberOfBlocksChanged(ptr.Pointer())
...
func (ptr *BlockchainStatusModel) NumberOfBlocksChanged(numberOfBlocks string) {
	if ptr.Pointer() != nil {
		...
		C.BlockchainStatusModel0d0160_NumberOfBlocksChanged(ptr.Pointer(), C.struct_Moc_PackedString{data: numberOfBlocksC, len: C.longlong(len(numberOfBlocks))})
	}
}

//export callbackBlockchainStatusModel0d0160_TimestampLastBlock
func callbackBlockchainStatusModel0d0160_TimestampLastBlock(ptr unsafe.Pointer) unsafe.Pointer {
...
func (ptr *BlockchainStatusModel) TimestampLastBlock() *std_core.QDateTime {
	if ptr.Pointer() != nil {
		tmpValue := std_core.NewQDateTimeFromPointer(C.BlockchainStatusModel0d0160_TimestampLastBlock(ptr.Pointer()))
...
func (ptr *BlockchainStatusModel) TimestampLastBlockDefault() *std_core.QDateTime {
	if ptr.Pointer() != nil {
		tmpValue := std_core.NewQDateTimeFromPointer(C.BlockchainStatusModel0d0160_TimestampLastBlockDefault(ptr.Pointer()))
		runtime.SetFinalizer(tmpValue, (*std_core.QDateTime).DestroyQDateTime)
		return tmpValue
	}
	return nil
...
//export callbackBlockchainStatusModel0d0160_SetTimestampLastBlock
func callbackBlockchainStatusModel0d0160_SetTimestampLastBlock(ptr unsafe.Pointer, timestampLastBlock unsafe.Pointer) {
...
func (ptr *BlockchainStatusModel) SetTimestampLastBlock(timestampLastBlock std_core.QDateTime_ITF) {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160_SetTimestampLastBlock(ptr.Pointer(), std_core.PointerFromQDateTime(timestampLastBlock))
	}
}

func (ptr *BlockchainStatusModel) SetTimestampLastBlockDefault(timestampLastBlock std_core.QDateTime_ITF) {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160_SetTimestampLastBlockDefault(ptr.Pointer(), std_core.PointerFromQDateTime(timestampLastBlock))
	}
}

//export callbackBlockchainStatusModel0d0160_TimestampLastBlockChanged
func callbackBlockchainStatusModel0d0160_TimestampLastBlockChanged(ptr unsafe.Pointer, timestampLastBlock unsafe.Pointer) {
...
func (ptr *BlockchainStatusModel) ConnectTimestampLastBlockChanged(f func(timestampLastBlock *std_core.QDateTime)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "timestampLastBlockChanged") {
			C.BlockchainStatusModel0d0160_ConnectTimestampLastBlockChanged(ptr.Pointer())
		}
...
func (ptr *BlockchainStatusModel) DisconnectTimestampLastBlockChanged() {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160_DisconnectTimestampLastBlockChanged(ptr.Pointer())
...
func (ptr *BlockchainStatusModel) TimestampLastBlockChanged(timestampLastBlock std_core.QDateTime_ITF) {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160_TimestampLastBlockChanged(ptr.Pointer(), std_core.PointerFromQDateTime(timestampLastBlock))
	}
}

//export callbackBlockchainStatusModel0d0160_HashLastBlock
func callbackBlockchainStatusModel0d0160_HashLastBlock(ptr unsafe.Pointer) C.struct_Moc_PackedString {
...
func (ptr *BlockchainStatusModel) HashLastBlock() string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.BlockchainStatusModel0d0160_HashLastBlock(ptr.Pointer()))
	}
	return ""
}
...
func (ptr *BlockchainStatusModel) HashLastBlockDefault() string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.BlockchainStatusModel0d0160_HashLastBlockDefault(ptr.Pointer()))
	}
	return ""
}

//export callbackBlockchainStatusModel0d0160_SetHashLastBlock
func callbackBlockchainStatusModel0d0160_SetHashLastBlock(ptr unsafe.Pointer, hashLastBlock C.struct_Moc_PackedString) {
...
func (ptr *BlockchainStatusModel) SetHashLastBlock(hashLastBlock string) {
	if ptr.Pointer() != nil {
		...
		C.BlockchainStatusModel0d0160_SetHashLastBlock(ptr.Pointer(), C.struct_Moc_PackedString{data: hashLastBlockC, len: C.longlong(len(hashLastBlock))})
	}
}
...
func (ptr *BlockchainStatusModel) SetHashLastBlockDefault(hashLastBlock string) {
	if ptr.Pointer() != nil {
		...
		C.BlockchainStatusModel0d0160_SetHashLastBlockDefault(ptr.Pointer(), C.struct_Moc_PackedString{data: hashLastBlockC, len: C.longlong(len(hashLastBlock))})
	}
}

//export callbackBlockchainStatusModel0d0160_HashLastBlockChanged
func callbackBlockchainStatusModel0d0160_HashLastBlockChanged(ptr unsafe.Pointer, hashLastBlock C.struct_Moc_PackedString) {
...
func (ptr *BlockchainStatusModel) ConnectHashLastBlockChanged(f func(hashLastBlock string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "hashLastBlockChanged") {
			C.BlockchainStatusModel0d0160_ConnectHashLastBlockChanged(ptr.Pointer())
		}
...
func (ptr *BlockchainStatusModel) DisconnectHashLastBlockChanged() {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160_DisconnectHashLastBlockChanged(ptr.Pointer())
...
func (ptr *BlockchainStatusModel) HashLastBlockChanged(hashLastBlock string) {
	if ptr.Pointer() != nil {
		...
		C.BlockchainStatusModel0d0160_HashLastBlockChanged(ptr.Pointer(), C.struct_Moc_PackedString{data: hashLastBlockC, len: C.longlong(len(hashLastBlock))})
	}
}

//export callbackBlockchainStatusModel0d0160_CurrentSkySupply
func callbackBlockchainStatusModel0d0160_CurrentSkySupply(ptr unsafe.Pointer) C.struct_Moc_PackedString {
...
func (ptr *BlockchainStatusModel) CurrentSkySupply() string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.BlockchainStatusModel0d0160_CurrentSkySupply(ptr.Pointer()))
	}
	return ""
}
...
func (ptr *BlockchainStatusModel) CurrentSkySupplyDefault() string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.BlockchainStatusModel0d0160_CurrentSkySupplyDefault(ptr.Pointer()))
	}
	return ""
}

//export callbackBlockchainStatusModel0d0160_SetCurrentSkySupply
func callbackBlockchainStatusModel0d0160_SetCurrentSkySupply(ptr unsafe.Pointer, currentSkySupply C.struct_Moc_PackedString) {
...
func (ptr *BlockchainStatusModel) SetCurrentSkySupply(currentSkySupply string) {
	if ptr.Pointer() != nil {
		...
		C.BlockchainStatusModel0d0160_SetCurrentSkySupply(ptr.Pointer(), C.struct_Moc_PackedString{data: currentSkySupplyC, len: C.longlong(len(currentSkySupply))})
	}
}
...
func (ptr *BlockchainStatusModel) SetCurrentSkySupplyDefault(currentSkySupply string) {
	if ptr.Pointer() != nil {
		...
		C.BlockchainStatusModel0d0160_SetCurrentSkySupplyDefault(ptr.Pointer(), C.struct_Moc_PackedString{data: currentSkySupplyC, len: C.longlong(len(currentSkySupply))})
	}
}

//export callbackBlockchainStatusModel0d0160_CurrentSkySupplyChanged
func callbackBlockchainStatusModel0d0160_CurrentSkySupplyChanged(ptr unsafe.Pointer, currentSkySupply C.struct_Moc_PackedString) {
...
func (ptr *BlockchainStatusModel) ConnectCurrentSkySupplyChanged(f func(currentSkySupply string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "currentSkySupplyChanged") {
			C.BlockchainStatusModel0d0160_ConnectCurrentSkySupplyChanged(ptr.Pointer())
		}
...
func (ptr *BlockchainStatusModel) DisconnectCurrentSkySupplyChanged() {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160_DisconnectCurrentSkySupplyChanged(ptr.Pointer())
...
func (ptr *BlockchainStatusModel) CurrentSkySupplyChanged(currentSkySupply string) {
	if ptr.Pointer() != nil {
		...
		C.BlockchainStatusModel0d0160_CurrentSkySupplyChanged(ptr.Pointer(), C.struct_Moc_PackedString{data: currentSkySupplyC, len: C.longlong(len(currentSkySupply))})
	}
}

//export callbackBlockchainStatusModel0d0160_TotalSkySupply
func callbackBlockchainStatusModel0d0160_TotalSkySupply(ptr unsafe.Pointer) C.struct_Moc_PackedString {
...
func (ptr *BlockchainStatusModel) TotalSkySupply() string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.BlockchainStatusModel0d0160_TotalSkySupply(ptr.Pointer()))
	}
	return ""
}
...
func (ptr *BlockchainStatusModel) TotalSkySupplyDefault() string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.BlockchainStatusModel0d0160_TotalSkySupplyDefault(ptr.Pointer()))
	}
	return ""
}

//export callbackBlockchainStatusModel0d0160_SetTotalSkySupply
func callbackBlockchainStatusModel0d0160_SetTotalSkySupply(ptr unsafe.Pointer, totalSkySupply C.struct_Moc_PackedString) {
...
func (ptr *BlockchainStatusModel) SetTotalSkySupply(totalSkySupply string) {
	if ptr.Pointer() != nil {
		...
		C.BlockchainStatusModel0d0160_SetTotalSkySupply(ptr.Pointer(), C.struct_Moc_PackedString{data: totalSkySupplyC, len: C.longlong(len(totalSkySupply))})
	}
}
...
func (ptr *BlockchainStatusModel) SetTotalSkySupplyDefault(totalSkySupply string) {
	if ptr.Pointer() != nil {
		...
		C.BlockchainStatusModel0d0160_SetTotalSkySupplyDefault(ptr.Pointer(), C.struct_Moc_PackedString{data: totalSkySupplyC, len: C.longlong(len(totalSkySupply))})
	}
}

//export callbackBlockchainStatusModel0d0160_TotalSkySupplyChanged
func callbackBlockchainStatusModel0d0160_TotalSkySupplyChanged(ptr unsafe.Pointer, totalSkySupply C.struct_Moc_PackedString) {
...
func (ptr *BlockchainStatusModel) ConnectTotalSkySupplyChanged(f func(totalSkySupply string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "totalSkySupplyChanged") {
			C.BlockchainStatusModel0d0160_ConnectTotalSkySupplyChanged(ptr.Pointer())
		}
...
func (ptr *BlockchainStatusModel) DisconnectTotalSkySupplyChanged() {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160_DisconnectTotalSkySupplyChanged(ptr.Pointer())
...
func (ptr *BlockchainStatusModel) TotalSkySupplyChanged(totalSkySupply string) {
	if ptr.Pointer() != nil {
		...
		C.BlockchainStatusModel0d0160_TotalSkySupplyChanged(ptr.Pointer(), C.struct_Moc_PackedString{data: totalSkySupplyC, len: C.longlong(len(totalSkySupply))})
	}
}

//export callbackBlockchainStatusModel0d0160_CurrentCoinHoursSupply
func callbackBlockchainStatusModel0d0160_CurrentCoinHoursSupply(ptr unsafe.Pointer) C.struct_Moc_PackedString {
...
func (ptr *BlockchainStatusModel) CurrentCoinHoursSupply() string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.BlockchainStatusModel0d0160_CurrentCoinHoursSupply(ptr.Pointer()))
	}
	return ""
}
...
func (ptr *BlockchainStatusModel) CurrentCoinHoursSupplyDefault() string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.BlockchainStatusModel0d0160_CurrentCoinHoursSupplyDefault(ptr.Pointer()))
	}
	return ""
}

//export callbackBlockchainStatusModel0d0160_SetCurrentCoinHoursSupply
func callbackBlockchainStatusModel0d0160_SetCurrentCoinHoursSupply(ptr unsafe.Pointer, currentCoinHoursSupply C.struct_Moc_PackedString) {
...
func (ptr *BlockchainStatusModel) SetCurrentCoinHoursSupply(currentCoinHoursSupply string) {
	if ptr.Pointer() != nil {
		...
		C.BlockchainStatusModel0d0160_SetCurrentCoinHoursSupply(ptr.Pointer(), C.struct_Moc_PackedString{data: currentCoinHoursSupplyC, len: C.longlong(len(currentCoinHoursSupply))})
	}
}
...
func (ptr *BlockchainStatusModel) SetCurrentCoinHoursSupplyDefault(currentCoinHoursSupply string) {
	if ptr.Pointer() != nil {
		...
		C.BlockchainStatusModel0d0160_SetCurrentCoinHoursSupplyDefault(ptr.Pointer(), C.struct_Moc_PackedString{data: currentCoinHoursSupplyC, len: C.longlong(len(currentCoinHoursSupply))})
	}
}

//export callbackBlockchainStatusModel0d0160_CurrentCoinHoursSupplyChanged
func callbackBlockchainStatusModel0d0160_CurrentCoinHoursSupplyChanged(ptr unsafe.Pointer, currentCoinHoursSupply C.struct_Moc_PackedString) {
...
func (ptr *BlockchainStatusModel) ConnectCurrentCoinHoursSupplyChanged(f func(currentCoinHoursSupply string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "currentCoinHoursSupplyChanged") {
			C.BlockchainStatusModel0d0160_ConnectCurrentCoinHoursSupplyChanged(ptr.Pointer())
		}
...
func (ptr *BlockchainStatusModel) DisconnectCurrentCoinHoursSupplyChanged() {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160_DisconnectCurrentCoinHoursSupplyChanged(ptr.Pointer())
...
func (ptr *BlockchainStatusModel) CurrentCoinHoursSupplyChanged(currentCoinHoursSupply string) {
	if ptr.Pointer() != nil {
		...
		C.BlockchainStatusModel0d0160_CurrentCoinHoursSupplyChanged(ptr.Pointer(), C.struct_Moc_PackedString{data: currentCoinHoursSupplyC, len: C.longlong(len(currentCoinHoursSupply))})
	}
}

//export callbackBlockchainStatusModel0d0160_TotalCoinHoursSupply
func callbackBlockchainStatusModel0d0160_TotalCoinHoursSupply(ptr unsafe.Pointer) C.struct_Moc_PackedString {
...
func (ptr *BlockchainStatusModel) TotalCoinHoursSupply() string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.BlockchainStatusModel0d0160_TotalCoinHoursSupply(ptr.Pointer()))
	}
	return ""
}
...
func (ptr *BlockchainStatusModel) TotalCoinHoursSupplyDefault() string {
	if ptr.Pointer() != nil {
		return cGoUnpackString(C.BlockchainStatusModel0d0160_TotalCoinHoursSupplyDefault(ptr.Pointer()))
	}
	return ""
}

//export callbackBlockchainStatusModel0d0160_SetTotalCoinHoursSupply
func callbackBlockchainStatusModel0d0160_SetTotalCoinHoursSupply(ptr unsafe.Pointer, totalCoinHoursSupply C.struct_Moc_PackedString) {
...
func (ptr *BlockchainStatusModel) SetTotalCoinHoursSupply(totalCoinHoursSupply string) {
	if ptr.Pointer() != nil {
		...
		C.BlockchainStatusModel0d0160_SetTotalCoinHoursSupply(ptr.Pointer(), C.struct_Moc_PackedString{data: totalCoinHoursSupplyC, len: C.longlong(len(totalCoinHoursSupply))})
	}
}
...
func (ptr *BlockchainStatusModel) SetTotalCoinHoursSupplyDefault(totalCoinHoursSupply string) {
	if ptr.Pointer() != nil {
		...
		C.BlockchainStatusModel0d0160_SetTotalCoinHoursSupplyDefault(ptr.Pointer(), C.struct_Moc_PackedString{data: totalCoinHoursSupplyC, len: C.longlong(len(totalCoinHoursSupply))})
	}
}

//export callbackBlockchainStatusModel0d0160_TotalCoinHoursSupplyChanged
func callbackBlockchainStatusModel0d0160_TotalCoinHoursSupplyChanged(ptr unsafe.Pointer, totalCoinHoursSupply C.struct_Moc_PackedString) {
...
func (ptr *BlockchainStatusModel) ConnectTotalCoinHoursSupplyChanged(f func(totalCoinHoursSupply string)) {
	if ptr.Pointer() != nil {
		...
		if !qt.ExistsSignal(ptr.Pointer(), "totalCoinHoursSupplyChanged") {
			C.BlockchainStatusModel0d0160_ConnectTotalCoinHoursSupplyChanged(ptr.Pointer())
		}
...
func (ptr *BlockchainStatusModel) DisconnectTotalCoinHoursSupplyChanged() {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160_DisconnectTotalCoinHoursSupplyChanged(ptr.Pointer())
...
func (ptr *BlockchainStatusModel) TotalCoinHoursSupplyChanged(totalCoinHoursSupply string) {
	if ptr.Pointer() != nil {
		...
		C.BlockchainStatusModel0d0160_TotalCoinHoursSupplyChanged(ptr.Pointer(), C.struct_Moc_PackedString{data: totalCoinHoursSupplyC, len: C.longlong(len(totalCoinHoursSupply))})
	}
}

func BlockchainStatusModel_QRegisterMetaType() int {
	return int(int32(C.BlockchainStatusModel0d0160_BlockchainStatusModel0d0160_QRegisterMetaType()))
}
...
func BlockchainStatusModel_QRegisterMetaType2(typeName string) int {
	...
	return int(int32(C.BlockchainStatusModel0d0160_BlockchainStatusModel0d0160_QRegisterMetaType2(typeNameC)))
}
...
func BlockchainStatusModel_QmlRegisterType() int {
	return int(int32(C.BlockchainStatusModel0d0160_BlockchainStatusModel0d0160_QmlRegisterType()))
}
...
func BlockchainStatusModel_QmlRegisterType2(uri string, versionMajor int, versionMinor int, qmlName string) int {
	...
	return int(int32(C.BlockchainStatusModel0d0160_BlockchainStatusModel0d0160_QmlRegisterType2(uriC, C.int(int32(versionMajor)), C.int(int32(versionMinor)), qmlNameC)))
}
...
func (ptr *BlockchainStatusModel) __children_atList(i int) *std_core.QObject {
	if ptr.Pointer() != nil {
		tmpValue := std_core.NewQObjectFromPointer(C.BlockchainStatusModel0d0160___children_atList(ptr.Pointer(), C.int(int32(i))))
...
func (ptr *BlockchainStatusModel) __children_setList(i std_core.QObject_ITF) {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160___children_setList(ptr.Pointer(), std_core.PointerFromQObject(i))
	}
}

func (ptr *BlockchainStatusModel) __children_newList() unsafe.Pointer {
	return C.BlockchainStatusModel0d0160___children_newList(ptr.Pointer())
}

func (ptr *BlockchainStatusModel) __dynamicPropertyNames_atList(i int) *std_core.QByteArray {
	if ptr.Pointer() != nil {
		tmpValue := std_core.NewQByteArrayFromPointer(C.BlockchainStatusModel0d0160___dynamicPropertyNames_atList(ptr.Pointer(), C.int(int32(i))))
...
func (ptr *BlockchainStatusModel) __dynamicPropertyNames_setList(i std_core.QByteArray_ITF) {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160___dynamicPropertyNames_setList(ptr.Pointer(), std_core.PointerFromQByteArray(i))
	}
}

func (ptr *BlockchainStatusModel) __dynamicPropertyNames_newList() unsafe.Pointer {
	return C.BlockchainStatusModel0d0160___dynamicPropertyNames_newList(ptr.Pointer())
}

func (ptr *BlockchainStatusModel) __findChildren_atList(i int) *std_core.QObject {
	if ptr.Pointer() != nil {
		tmpValue := std_core.NewQObjectFromPointer(C.BlockchainStatusModel0d0160___findChildren_atList(ptr.Pointer(), C.int(int32(i))))
		if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
			tmpValue.ConnectDestroyed(func(*std_core.QObject) { tmpValue.SetPointer(nil) })
		}
		return tmpValue
...
func (ptr *BlockchainStatusModel) __findChildren_setList(i std_core.QObject_ITF) {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160___findChildren_setList(ptr.Pointer(), std_core.PointerFromQObject(i))
	}
}

func (ptr *BlockchainStatusModel) __findChildren_newList() unsafe.Pointer {
	return C.BlockchainStatusModel0d0160___findChildren_newList(ptr.Pointer())
}

func (ptr *BlockchainStatusModel) __findChildren_atList3(i int) *std_core.QObject {
	if ptr.Pointer() != nil {
		tmpValue := std_core.NewQObjectFromPointer(C.BlockchainStatusModel0d0160___findChildren_atList3(ptr.Pointer(), C.int(int32(i))))
		if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
			tmpValue.ConnectDestroyed(func(*std_core.QObject) { tmpValue.SetPointer(nil) })
		}
		return tmpValue
...
func (ptr *BlockchainStatusModel) __findChildren_setList3(i std_core.QObject_ITF) {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160___findChildren_setList3(ptr.Pointer(), std_core.PointerFromQObject(i))
	}
}

func (ptr *BlockchainStatusModel) __findChildren_newList3() unsafe.Pointer {
	return C.BlockchainStatusModel0d0160___findChildren_newList3(ptr.Pointer())
}

func (ptr *BlockchainStatusModel) __qFindChildren_atList2(i int) *std_core.QObject {
	if ptr.Pointer() != nil {
		tmpValue := std_core.NewQObjectFromPointer(C.BlockchainStatusModel0d0160___qFindChildren_atList2(ptr.Pointer(), C.int(int32(i))))
		if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
			tmpValue.ConnectDestroyed(func(*std_core.QObject) { tmpValue.SetPointer(nil) })
		}
		return tmpValue
...
func (ptr *BlockchainStatusModel) __qFindChildren_setList2(i std_core.QObject_ITF) {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160___qFindChildren_setList2(ptr.Pointer(), std_core.PointerFromQObject(i))
	}
}

func (ptr *BlockchainStatusModel) __qFindChildren_newList2() unsafe.Pointer {
	return C.BlockchainStatusModel0d0160___qFindChildren_newList2(ptr.Pointer())
}

func NewBlockchainStatusModel(parent std_core.QObject_ITF) *BlockchainStatusModel {
	tmpValue := NewBlockchainStatusModelFromPointer(C.BlockchainStatusModel0d0160_NewBlockchainStatusModel(std_core.PointerFromQObject(parent)))
	if !qt.ExistsSignal(tmpValue.Pointer(), "destroyed") {
		tmpValue.ConnectDestroyed(func(*std_core.QObject) { tmpValue.SetPointer(nil) })
	}
	return tmpValue
...
//export callbackBlockchainStatusModel0d0160_DestroyBlockchainStatusModel
func callbackBlockchainStatusModel0d0160_DestroyBlockchainStatusModel(ptr unsafe.Pointer) {
...
func (ptr *BlockchainStatusModel) DestroyBlockchainStatusModel() {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160_DestroyBlockchainStatusModel(ptr.Pointer())
		ptr.SetPointer(nil)
...
func (ptr *BlockchainStatusModel) DestroyBlockchainStatusModelDefault() {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160_DestroyBlockchainStatusModelDefault(ptr.Pointer())
		ptr.SetPointer(nil)
		runtime.SetFinalizer(ptr, nil)
	}
}

//export callbackBlockchainStatusModel0d0160_ChildEvent
func callbackBlockchainStatusModel0d0160_ChildEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
...
func (ptr *BlockchainStatusModel) ChildEventDefault(event std_core.QChildEvent_ITF) {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160_ChildEventDefault(ptr.Pointer(), std_core.PointerFromQChildEvent(event))
	}
}

//export callbackBlockchainStatusModel0d0160_ConnectNotify
func callbackBlockchainStatusModel0d0160_ConnectNotify(ptr unsafe.Pointer, sign unsafe.Pointer) {
...
func (ptr *BlockchainStatusModel) ConnectNotifyDefault(sign std_core.QMetaMethod_ITF) {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160_ConnectNotifyDefault(ptr.Pointer(), std_core.PointerFromQMetaMethod(sign))
	}
}

//export callbackBlockchainStatusModel0d0160_CustomEvent
func callbackBlockchainStatusModel0d0160_CustomEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
...
func (ptr *BlockchainStatusModel) CustomEventDefault(event std_core.QEvent_ITF) {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160_CustomEventDefault(ptr.Pointer(), std_core.PointerFromQEvent(event))
	}
}

//export callbackBlockchainStatusModel0d0160_DeleteLater
func callbackBlockchainStatusModel0d0160_DeleteLater(ptr unsafe.Pointer) {
...
func (ptr *BlockchainStatusModel) DeleteLaterDefault() {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160_DeleteLaterDefault(ptr.Pointer())
		runtime.SetFinalizer(ptr, nil)
	}
}

//export callbackBlockchainStatusModel0d0160_Destroyed
func callbackBlockchainStatusModel0d0160_Destroyed(ptr unsafe.Pointer, obj unsafe.Pointer) {
...
//export callbackBlockchainStatusModel0d0160_DisconnectNotify
func callbackBlockchainStatusModel0d0160_DisconnectNotify(ptr unsafe.Pointer, sign unsafe.Pointer) {
...
func (ptr *BlockchainStatusModel) DisconnectNotifyDefault(sign std_core.QMetaMethod_ITF) {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160_DisconnectNotifyDefault(ptr.Pointer(), std_core.PointerFromQMetaMethod(sign))
	}
}

//export callbackBlockchainStatusModel0d0160_Event
func callbackBlockchainStatusModel0d0160_Event(ptr unsafe.Pointer, e unsafe.Pointer) C.char {
...
func (ptr *BlockchainStatusModel) EventDefault(e std_core.QEvent_ITF) bool {
	if ptr.Pointer() != nil {
		return int8(C.BlockchainStatusModel0d0160_EventDefault(ptr.Pointer(), std_core.PointerFromQEvent(e))) != 0
	}
	return false
}

//export callbackBlockchainStatusModel0d0160_EventFilter
func callbackBlockchainStatusModel0d0160_EventFilter(ptr unsafe.Pointer, watched unsafe.Pointer, event unsafe.Pointer) C.char {
...
func (ptr *BlockchainStatusModel) EventFilterDefault(watched std_core.QObject_ITF, event std_core.QEvent_ITF) bool {
	if ptr.Pointer() != nil {
		return int8(C.BlockchainStatusModel0d0160_EventFilterDefault(ptr.Pointer(), std_core.PointerFromQObject(watched), std_core.PointerFromQEvent(event))) != 0
	}
	return false
}

//export callbackBlockchainStatusModel0d0160_ObjectNameChanged
func callbackBlockchainStatusModel0d0160_ObjectNameChanged(ptr unsafe.Pointer, objectName C.struct_Moc_PackedString) {
...
//export callbackBlockchainStatusModel0d0160_TimerEvent
func callbackBlockchainStatusModel0d0160_TimerEvent(ptr unsafe.Pointer, event unsafe.Pointer) {
...
func (ptr *BlockchainStatusModel) TimerEventDefault(event std_core.QTimerEvent_ITF) {
	if ptr.Pointer() != nil {
		C.BlockchainStatusModel0d0160_TimerEventDefault(ptr.Pointer(), std_core.PointerFromQTimerEvent(event))
	}
}
