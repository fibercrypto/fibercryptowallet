...
Q_PROPERTY(quintptr addresses READ addresses WRITE setAddresses NOTIFY addressesChanged)
...
public:
	...
	quintptr addresses() { return callbackAddressesModel268d39_Addresses(this); };
	void setAddresses(quintptr addresses) { callbackAddressesModel268d39_SetAddresses(this, addresses); };
	void Signal_AddressesChanged(quintptr addresses) { callbackAddressesModel268d39_AddressesChanged(this, addresses); };
	...
	quintptr addressesDefault() { return _addresses; };
	void setAddressesDefault(quintptr p) { if (p != _addresses) { _addresses = p; addressesChanged(_addresses); } };
...
signals:
	...
	void addressesChanged(quintptr addresses);
...
uintptr_t AddressesModel268d39_Addresses(void* ptr)
{
	return static_cast<AddressesModel268d39*>(ptr)->addresses();
}

uintptr_t AddressesModel268d39_AddressesDefault(void* ptr)
{
	return static_cast<AddressesModel268d39*>(ptr)->addressesDefault();
}

void AddressesModel268d39_SetAddresses(void* ptr, uintptr_t addresses)
{
	static_cast<AddressesModel268d39*>(ptr)->setAddresses(addresses);
}

void AddressesModel268d39_SetAddressesDefault(void* ptr, uintptr_t addresses)
{
	static_cast<AddressesModel268d39*>(ptr)->setAddressesDefault(addresses);
}

void AddressesModel268d39_ConnectAddressesChanged(void* ptr)
{
	QObject::connect(static_cast<AddressesModel268d39*>(ptr), static_cast<void (AddressesModel268d39::*)(quintptr)>(&AddressesModel268d39::addressesChanged), static_cast<AddressesModel268d39*>(ptr), static_cast<void (AddressesModel268d39::*)(quintptr)>(&AddressesModel268d39::Signal_AddressesChanged));
}

void AddressesModel268d39_DisconnectAddressesChanged(void* ptr)
{
	QObject::disconnect(static_cast<AddressesModel268d39*>(ptr), static_cast<void (AddressesModel268d39::*)(quintptr)>(&AddressesModel268d39::addressesChanged), static_cast<AddressesModel268d39*>(ptr), static_cast<void (AddressesModel268d39::*)(quintptr)>(&AddressesModel268d39::Signal_AddressesChanged));
}

void AddressesModel268d39_AddressesChanged(void* ptr, uintptr_t addresses)
{
	static_cast<AddressesModel268d39*>(ptr)->addressesChanged(addresses);
}
...
void WalletManager268d39_CreateEncryptedWallet(void* ptr, struct Moc_PackedString seed, struct Moc_PackedString label, struct Moc_PackedString password, int scanN)
{
	QMetaObject::invokeMethod(static_cast<WalletManager268d39*>(ptr), "createEncryptedWallet", Q_ARG(QString, QString::fromUtf8(seed.data, seed.len)), Q_ARG(QString, QString::fromUtf8(label.data, label.len)), Q_ARG(QString, QString::fromUtf8(password.data, password.len)), Q_ARG(qint32, scanN));
}

void WalletManager268d39_CreateUnencryptedWallet(void* ptr, struct Moc_PackedString seed, struct Moc_PackedString label, int scanN)
{
	QMetaObject::invokeMethod(static_cast<WalletManager268d39*>(ptr), "createUnencryptedWallet", Q_ARG(QString, QString::fromUtf8(seed.data, seed.len)), Q_ARG(QString, QString::fromUtf8(label.data, label.len)), Q_ARG(qint32, scanN));
}
...
void WalletManager268d39_NewWalletAddress(void* ptr, struct Moc_PackedString id, int n, struct Moc_PackedString password)
{
	QMetaObject::invokeMethod(static_cast<WalletManager268d39*>(ptr), "newWalletAddress", Q_ARG(QString, QString::fromUtf8(id.data, id.len)), Q_ARG(qint32, n), Q_ARG(QString, QString::fromUtf8(password.data, password.len)));
}

void WalletManager268d39_EncryptWallet(void* ptr, struct Moc_PackedString id, struct Moc_PackedString password)
{
	QMetaObject::invokeMethod(static_cast<WalletManager268d39*>(ptr), "encryptWallet", Q_ARG(QString, QString::fromUtf8(id.data, id.len)), Q_ARG(QString, QString::fromUtf8(password.data, password.len)));
}

void WalletManager268d39_DecryptWallet(void* ptr, struct Moc_PackedString id, struct Moc_PackedString password)
{
	QMetaObject::invokeMethod(static_cast<WalletManager268d39*>(ptr), "decryptWallet", Q_ARG(QString, QString::fromUtf8(id.data, id.len)), Q_ARG(QString, QString::fromUtf8(password.data, password.len)));
}
